...
Next, define interface data types with a NewInterface instance. Instances for interfaces with only wlid are autogenerated:
...
-- `instance NewInterface Wp_fifo_manager_v1` is autogenerated since it only has a wlid field.
